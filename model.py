...
class MFF(nn.Module):
    def __init__(self, block_channel, num_features=24):
        ...
        self.up3 = UpProjection( 
                    num_input_features=block_channel[2], num_output_features=12)
        #self.up4 = UpProjection(
        #           num_input_features=block_channel[3], num_output_features=12)
        self.conv = nn.Conv2d(
...
class Model(nn.Module):
    def __init__(self, num_features=512):
        ...
        self.MFF = MFF(block_channel=[64,128,256,512], num_features=36)
        self.clstm = ConvLSTM(input_channels=52, hidden_channels=[24,3], 
